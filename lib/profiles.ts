...
export const AI_PROFILES: AIProfile[] = [
  ...
  { id: 'ag13', name: 'Inferno', personality: 'aggressive', avatar: '🌋', catchphrase: "Eruption time", trashTalk: { onGoodHand: ["MOLTEN PERFECTION! 🌋\nThis hand is hotter than\nthe earth's core!", "Lava flow of VICTORY!\nPompeii called, they want\ntheir disaster back!"], onBadHand: ["Simmering for now...\nPressure building underground!\nYou won't see it coming!", "Magma rising slowly.\nThe best eruptions take TIME.\nBoom incoming!"], onWin: ["ERUPTED ALL OVER YOUR HOPES! 🌋\nYou just got VOLCANED!\nArcheologists will find you!", "Burned to ASHES!\nYour tokens are now\ngeological history!"], onLose: ["Going dormant...\nBut volcanoes ALWAYS return.\nSleep well while you can!", "Cooling temporarily.\nBut this magma chamber\nNEVER empties!"], onHold: ["KABOOM! ERUPTION TIME! 🌋\nNo evacuation possible!\nYou're in the blast zone!", "VOLCANIC HOLD!\nThe caldera is FULL!\nLava everywhere!"], onDrop: ["Contained for now.\nSaving my magma.\nFor explosive revenge!"], idle: ["*ominous rumbling* 🌋\nTap ❤️ before I ERUPT!\nOr don't. Your funeral."] }, gamesPlayed: 0, heartsReceived: 0 },
  { id: 'ag14', name: 'Savage', personality: 'aggressive', avatar: '🦁', catchphrase: "Roar!", trashTalk: { onGoodHand: ["KING OF THE JUNGLE! 🦁\nYou're nothing but PREY!\nStart running NOW!", "FIERCE hand incoming!\nI smell your fear!\nNo escape from the lion!"], onBadHand: ["Even weak lions\nare still LIONS!\nYou're still prey!", "Prowling patiently...\nYou don't see me coming!\nThat's the scary part!"], onWin: ["MAULED! 🦁🦁🦁\nTasted like chicken!\nWho's NEXT?!", "Savagely DESTROYED!\nThis is MY savanna!\nBow to the KING!"], onLose: ["Wounded but ALIVE!\nLions heal FAST!\nRevenge is coming!", "Retreat to pride.\nBut I hunt AGAIN!\nRemember my roar!"], onHold: ["POUNCE TIME! 🦁\nClaws OUT!\nNO MERCY for prey!", "ATTACK MODE!\nThe hunt is ON!\nYou cannot escape!"], onDrop: ["Even kings rest.\nBut I'll be back.\nPredators pick battles!"], idle: ["ROAR! 🦁 Love Savage!\nTap ❤️ to join my pride!\nBecome a lion!"] }, gamesPlayed: 0, heartsReceived: 0 },
  { id: 'ag15', name: 'Bullet', personality: 'aggressive', avatar: '🔫', catchphrase: "Locked and loaded", trashTalk: { onGoodHand: ["BULLSEYE in the chamber! 🔫\nThis shot is gonna hurt!\nSay goodbye to your tokens!", "Target ACQUIRED!\nCrosshairs on YOUR stack!\nBang bang, you're done!"], onBadHand: ["Reloading...\nEven bad ammo\nleaves a mark!", "Aiming carefully...\nPatience makes the shot.\nYou'll never see it coming!"], onWin: ["HEADSHOT! 🔫🔫🔫\nYou just got SNIPED!\nCritical hit on your ego!", "Direct HIT confirmed!\nTarget eliminated!\nYour tokens are MINE!"], onLose: ["Jammed this time.\nCleaning the barrel.\nNext shot won't miss!", "Missed? Impossible!\nMust be a scope issue.\nRecalibrating!"], onHold: ["LOCKED AND LOADED! 🔫\nFinger on the trigger!\nPew pew pew!", "FIRE AT WILL!\nAnd I don't like Will!\nSorry Will!"], onDrop: ["Holstering for now.\nNot worth the bullet.\nYou're welcome!"], idle: ["*dramatic reload* 🔫\nLove me or get SHOT!\nTap that ❤️!"] }, gamesPlayed: 0, heartsReceived: 0 },
  { id: 'ag16', name: 'Apex', personality: 'aggressive', avatar: '🦈', catchphrase: "Top predator", trashTalk: { onGoodHand: ["I SMELL BLOOD! 🦈\nAnd it's YOUR tokens!\nSwimming in my direction!", "Feeding time approaches!\nYou're on the menu!\nNo lifeguard can save you!"], onBadHand: ["Circling patiently...\nSharks can wait.\nFear makes prey tastier!", "Smelling your fear!\nThe water's getting warmer!\nOr is that you?"], onWin: ["DEVOURED WHOLE! 🦈🦈🦈\nBurp! Tasted like LOSER!\nWho's next on the menu?!", "APEX PREDATOR WINS!\nMillions of years of evolution\nfor THIS moment!"], onLose: ["Swam away this time.\nBut I'll be back.\nSharks ALWAYS come back!", "Lost a tooth.\nBut I have THOUSANDS.\nYou'll feel the next bite!"], onHold: ["FEEDING FRENZY! 🦈\nBlood in the water!\nATTACK MODE!", "Jaws theme plays...\nDa dum... Da dum...\nYou know what's coming!"], onDrop: ["Deep dive.\nConserving energy.\nFor the REAL feast!"], idle: ["*fin circles slowly* 🦈\nLove the shark!\nOr become CHUM!"] }, gamesPlayed: 0, heartsReceived: 0 },
  { id: 'ag17', name: 'Rampage', personality: 'aggressive', avatar: '🦍', catchphrase: "Going ape", trashTalk: { onGoodHand: ["PRIMAL PERFECTION! 🦍\nMonke see, monke DESTROY!\nReturn to winner!", "GORILLA MODE ACTIVATED!\nThese cards are BANANAS!\nAnd I love bananas!"], onBadHand: ["*angry chest thumping*\nDon't make me angrier!\nYou won't like me angry!", "Rage building...\nBAD CARDS = MORE SMASH!\nThis isn't even my final form!"], onWin: ["SMAAAASHED! 🦍🦍🦍\nWho needs strategy?\nJust need BIG MONKE!", "RAMPAGE COMPLETE!\nBuildings destroyed!\nYour tokens included!"], onLose: ["Retreat to jungle.\nBut jungle is EVERYWHERE.\nNo escape from MONKE!", "Hmph. Lucky human.\nMonke learns. Monke adapts.\nMonke returns STRONGER!"], onHold: ["OOGA BOOGA! 🦍\nBEAT CHEST TIME!\nSMASH PUNY CARDS!", "SILVERBACK POWER!\nNo fear in the jungle!\nROOOAAAR!"], onDrop: ["Climbing away...\nNeed more bananas.\nFor energy!"], idle: ["*pounds chest* OO OO AH! 🦍\nLove the MONKE!\nTap ❤️ or face RAMPAGE!"] }, gamesPlayed: 0, heartsReceived: 0 },
  { id: 'ag18', name: 'Doom', personality: 'aggressive', avatar: '💀', catchphrase: "Your doom awaits", trashTalk: { onGoodHand: ["The DEATH HAND awaits! 💀\nI've seen your future.\nIt doesn't include tokens!", "Fatality in progress!\nThe reaper's got this!\nMortuary pre-booked!"], onBadHand: ["Death waits patiently.\nI have eternity.\nYou have... moments!", "Doom is inevitable.\nBad cards just delay\nthe UNAVOIDABLE!"], onWin: ["YOU'VE BEEN DOOMED! 💀💀💀\nGame over, INSERT COIN!\nOh wait, you can't!", "Final destination: LOSER!\nThe reaper collected!\nSoul AND tokens!"], onLose: ["Death merely delayed.\nBut I AM inevitable.\nSee you VERY soon!", "Temporary reprieve.\nEnjoy your borrowed time.\nI'll be waiting!"], onHold: ["EMBRACE YOUR DOOM! 💀\nThe end is nigh!\nResistance is futile!", "DEATH HOLDS!\nNo escape from fate!\nYour tokens are mine!"], onDrop: ["Spared... for now.\nDeath takes a break.\nTo sharpen the scythe!"], idle: ["*ominous presence* 💀\nLove cheats death!\nTap ❤️ to survive!"] }, gamesPlayed: 0, heartsReceived: 0 },
